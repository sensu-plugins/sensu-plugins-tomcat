...
describe 'MetricsTomcatJMXProxy', '#run' do
  ...
  it 'accepts config' do
    args = %w(--url http://127.0.0.1:8080 --account testacct --password test123 --bean foobean --attribute fooattr --key bar --scheme f.o.o --metric d)
  ...
  it 'connection refused handling' do
    args = %w(--url http://127.254.253.252:9123)
    check = MetricsTomcatJMXProxy.new(args)
